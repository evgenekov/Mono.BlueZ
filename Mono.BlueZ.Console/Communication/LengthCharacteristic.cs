...
namespace Mono.BlueZ.Console.Communication
{
    ...
    {
        private const string lengthUUID = "12345678-1234-5678-0002-56789abcdef1";
        private static readonly string[] flags = { "read" };
        private uint length;

        public LengthCharacteristic(Bus bus, int index, ObjectPath service) : base(bus, index, lengthUUID, flags, service)
        {
